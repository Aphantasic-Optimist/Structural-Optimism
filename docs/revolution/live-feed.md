...
Click the links above to browse the hashtag on each platform.
...
That's 2.2 million people studied (Wang et al. 2023).

Not philosophy. Epidemiology.
...
Yes, we're using social media to tell you to put down social media.

You can't escape a trap by pretending it doesn't exist.  
You escape by using it against itself.

This is judo. This is Gandhi. This is real.
