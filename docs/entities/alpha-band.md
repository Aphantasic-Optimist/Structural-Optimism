...
<div class="mini-graph" data-node-id="alpha-band" data-depth="2"></div>
...
Alpha band is one of the brain wave frequency ranges that shows coupling with heart rate variability through vagal mechanisms, as part of heart-brain synchronization across multiple frequency bands.
