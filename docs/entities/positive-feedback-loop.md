...
<div class="mini-graph" data-node-id="positive-feedback-loop" data-depth="2"></div>
...
Neurobiological mechanism where social interaction triggers oxytocin release → VTA dopamine neurons → nucleus accumbens reward → approach behavior → more social interaction, creating self-reinforcing cycle.
