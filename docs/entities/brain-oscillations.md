...
description: Brain oscillations
---
...
<div class="mini-graph" data-node-id="brain-oscillations" data-depth="2"></div>
...
Brain oscillations couple with heart rate variability through vagal mechanisms across delta, theta, alpha, beta, and gamma bands. High-frequency HRV shows stronger coupling with brain waves via cardiac sympathovagal activity.
...
- **SHOWS_COUPLING_WITH**: [High-frequency HRV](high-frequency-hrv.md)  
