...
<div class="mini-graph" data-node-id="social-isolation" data-depth="2"></div>
...
Social isolation inhibits oxytocin neuron activity, disrupting the VTA dopamine pathway. Lack of social connection increases all-cause mortality by ~50% (meta-analysis of 148 studies, 300k+ participants).
...
- **INHIBITS**: [oxytocin neuron activity](oxytocin-neuron-activity.md)  
