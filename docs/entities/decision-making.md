...
<div class="mini-graph" data-node-id="decision-making" data-depth="2"></div>
...
- **AFFECTS**: [serotonin](serotonin.md)  
  *Serotonin affects decision-making by functioning as brake promoting patience*
  📅 Valid since: 2026-02-04
  📚 Mentioned in 1 episode(s)

- **AFFECTS**: [dopamine](dopamine.md)  
  *Dopamine affects decision-making by acting as accelerator for reward-seeking behavior*
  📅 Valid since: 2026-02-04
  📚 Mentioned in 1 episode(s)
