...
<div class="mini-graph" data-node-id="brain-waves" data-depth="2"></div>
...
Brain waves synchronize with heart rate variability through vagal mechanisms. Coupling occurs across delta, theta, alpha, beta, and gamma bands. Cardiac sympathovagal activity initiates functional brain responses.
...
- **SYNCHRONIZES_WITH**: [Heart rate variability](heart-rate-variability.md)  
