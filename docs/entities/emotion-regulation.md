...
<div class="mini-graph" data-node-id="emotion-regulation" data-depth="2"></div>
...
Higher respiratory sinus arrhythmia (RSA) improves emotion regulation through myelinated vagal activity. Serotonin acts as brake promoting patience and long-term thinking in decision-making processes.
...
- **IMPROVES**: [Respiratory sinus arrhythmia](respiratory-sinus-arrhythmia.md)  
